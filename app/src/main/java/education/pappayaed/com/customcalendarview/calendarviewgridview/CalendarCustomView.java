...
public class CalendarCustomView extends LinearLayout {
    ...
    private void setUpCalendarAdapter() {
        ...
        EventObjects eventObjects = new EventObjects(3, "Test", Utils.convertStringToDate("14-04-2018"), Color.BLUE);

        mEvents.add(eventObjects);

        EventObjects eventObjects1 = new EventObjects(4, "sdfsdfsest", Utils.convertStringToDate("13-04-2018"), Color.RED);
